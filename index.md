...
* [MimicGen to LeRobot](https://github.com/kywch/mg2hfbot): Want to try LeRobot without a robot? This project converts MimicGen datasets, trains LeRobot policies (ACT, diffusion) on these datasets, and evaluates these on complex tasks.
